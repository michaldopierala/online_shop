...
const CookiesEn: React.FC = () => {
  return (
    <div className='Privacy'>
      ...
      <div className='lastUpdate'>Last updated February 14, 2024</div>
      <div className='text'>
        This privacy notice for (Company: "Michal Dopierala"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:
        <br></br>
        <ul>
          <li>Visit our website at sweetdream.ink, or any website of ours that links to this privacy notice</li>
          <li>Engage with us in other related ways, including any sales, marketing, or events</li>
        </ul>
        <b>Questions or concerns?</b> Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at michal6452@gmail.com.      </div>
      <div className='heading'>
        SUMMARY OF KEY POINTS
      </div>
      <div className='text'>
        <b>This summary provides key points from our privacy notice, but you can find out more details about any of these topics by clicking the link following each key point or by using our table of contents below to find the section you are looking for.</b>
        <br></br>     <br></br>
        <b> What personal information do we process?</b> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use.
        <br></br>  <br></br>
      ...
      <div className='text'>
        <b><h3>Personal information you disclose to us:</h3></b>
        ...
        <br></br><br></br>
        <b> Payment Data.</b> We may collect data necessary to process your payment if you make purchases, such as your payment instrument number, and the security code associated with your payment instrument. All payment data is stored by Stripe. You may find their privacy notice link(s) here: https://stripe.com/en-pl/privacy.
        <br></br> <br></br>
        ...
        <br></br> <br></br>
        <b><h3>The information we collect includes:</h3></b>
        <ul>
      ...
      <div className='text'>
        ...
        <ul>
          <li><b>Social Media Sharing and Advertising</b>
            <br></br>Facebook advertising
          </li>
          <li><b>Web and Mobile Analytics</b>
            <br></br>Google Analytics</li>
        </ul>
        We also may need to share your personal information in the following situations:
        <ul>
          <li><b>Business Transfers.</b>
            <br></br>We may share or transfer your information in connection with, or during negotiations of, any merger, sale of company assets, financing, or acquisition of all or a portion of our business to another company.
          </li>
          <li><b>When we use Google Analytics.</b>
            <br></br> We may share your information with Google Analytics to track and analyze the use of the Services. The Google Analytics Advertising Features that we may use include: Google Analytics Demographics and Interests Reporting. To opt out of being tracked by Google Analytics across the Services, visit https://tools.google.com/dlpage/gaoptout. You can opt out of Google Analytics Advertising Features through Ads Settings and Ad Settings for mobile apps. Other opt out means include http://optout.networkadvertising.org/ and http://www.networkadvertising.org/mobile-choice. For more information on the privacy practices of Google, please visit the <a href="https://policies.google.com/privacy" >Google Privacy & Terms page.</a></li>
        </ul>
      </div>
      <div className='heading'>
     ...
     <b> In Short:</b> We do not knowingly collect data from or market to children under 18 years of age.
      <br></br><br></br>
      We do not knowingly solicit data from or market to children under 18 years of age. By using the Services, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Services. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at michal6452@gmail.com.
      </div>
      <div className='heading'>
        8. WHAT ARE YOUR PRIVACY RIGHTS?
      </div>
      <div className='text'>
      <b>In Short:</b> In some regions, such as the European Economic Area (EEA), United Kingdom (UK), and Switzerland, you have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time.
      <br></br><br></br>
      ...
      <br></br><br></br>
      <b>Withdrawing your consent: </b>If we are relying on your consent to process your personal information, you have the right to withdraw your consent at any time. You can withdraw your consent at any time by contacting us by using the contact details provided on ouer website.
      <br></br><br></br>
      However, please note that this will not affect the lawfulness of the processing before its withdrawal nor, will it affect the processing of your personal information conducted in reliance on lawful processing grounds other than consent.
      <br></br><br></br>
      Cookies and similar technologies: Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Services.
      <br></br><br></br>
      If you have questions or comments about your privacy rights, you may email us at michal6452@gmail.com.
      <br></br><br></br>
      </div>
      <div className='heading'>
      ...
      <div className='text'>
      If you have questions or comments about this notice, you may email us at michal6452@gmail.com or contact us by post at:Michal Dopierala,Jedlec 61,Goluchow 63-322,Poland
      </div>
      <div className='heading'>
